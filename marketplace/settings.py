...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': f"http://{os.getenv('ELASTICSEARCH_HOST', 'localhost')}:{os.getenv('ELASTICSEARCH_PORT', '9200')}/",
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for classifieds marketplace platform',
    'VERSION': '1.0.0',
...
# Ad expiration settings (in days)
